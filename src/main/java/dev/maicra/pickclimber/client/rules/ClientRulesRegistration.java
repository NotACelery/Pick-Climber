...
public final class ClientRulesRegistration {
    ...
    public static void registerScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(ModMenus.CLIMBING_RULE_BOOK_PROCESSING.get(), ClimbingRuleBookProcessingScreen::new);
        ...
        ClimbingRulesClientUi.installExporter(definition -> {
            Minecraft minecraft = Minecraft.getInstance();
            minecraft.setScreen(new ClimbingRulesExportScreen(minecraft.screen, definition));
        });
